...
var (
	...
	RecruitmentsColumns = []*schema.Column{
		...
		{Name: "level", Type: field.TypeEnum, Nullable: true, Enums: []string{"unnecessary", "enjoy", "beginner", "middle", "expert", "open"}, Default: "unnecessary"},
		{Name: "place", Type: field.TypeString, Nullable: true},
		{Name: "start_at", Type: field.TypeTime, Nullable: true},
		{Name: "content", Type: field.TypeString, SchemaType: map[string]string{"postgres": "varchar(10000)"}},
