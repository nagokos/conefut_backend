...
func (s *Stock) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     s.ID,
		Type:   "Stock",
		Fields: make([]*Field, 4),
	...
	if buf, err = json.Marshal(s.RecruitmentID); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
...
func (u *User) Node(ctx context.Context) (node *Node, err error) {
	...
	node.Fields[7] = &Field{
		Type:  "user.EmailVerificationStatus",
	...
	if buf, err = json.Marshal(u.LastSignInAt); err != nil {
		return nil, err
	}
	node.Fields[11] = &Field{
		Type:  "time.Time",
